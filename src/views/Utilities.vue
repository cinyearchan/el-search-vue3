        ...
        <v-card-text>
          <v-row>
            <v-col cols="12" md="6" sm="12">
              ...
              <v-divider/>
              <v-list>
                <template v-for="utility in UTILITIES.create" :key="utility.method">
                  <utility
            ...
            <v-col cols="12" md="6" sm="12">
              ...
              <v-divider/>
              <v-list>
                <template v-for="utility in UTILITIES.delete" :key="utility.method">
                  <utility
                    :confirm-message="utility.confirmMessage"
                    :method="utility.method"
                    :method-params="utility.methodParams"
            ...
            <v-col cols="12" md="6" sm="12">
              ...
              <v-divider/>
              <v-list>
                <template v-for="utility in UTILITIES.misc" :key="utility.method">
                  <utility
                    :confirm-message="utility.confirmMessage"
                    :method="utility.method"
                    :method-params="utility.methodParams"
